#!/usr/bin/env python3
"""
Create an HDF5 file with attributes for testing attribute reading in DartFrame.
"""
...
def create_test_file():
    """Create test HDF5 file with various attributes"""
    
    with h5py.File('example/data/test_attributes.h5', 'w') as f:
        ...
        ds.attrs['range'] = [0.0, 100.0]
        ds.attrs['dimensions'] = [10, 10]
    ...
    print("Created test_attributes.h5 with:")
