  ...
  group('Series Missing Data Functions:', () {
    group('Series.isna()', () {
      test('Basic functionality with nulls', () {
        ...
        final expected = Series([false, true, false, true, false], name: 's_nulls_isna', index: s.index);
        final result = s.isna();
      ...
      test('No missing values', () {
        ...
        final expected = Series([false, false, false], name: 's_no_nulls_isna', index: s.index);
        final result = s.isna();
        expect(result.data, equals(expected.data));
        expect(result.name, equals(expected.name));
      });
      ...
      test('All missing values (null)', () {
        ...
        final expected = Series([true, true, true], name: 's_all_nulls_isna', index: s.index);
        final result = s.isna();
        expect(result.data, equals(expected.data));
        expect(result.name, equals(expected.name));
      });
      ...
      test('Custom missing value (-999) via DataFrame context', () {
        ...
        final s = df['colA'];
        final expected = Series([false, true, false], name: 'colA_isna', index: s.index);
        final result = s.isna();
        expect(result.data, equals(expected.data));
        expect(result.name, equals(expected.name));
      });
      ...
      test('Series of int with null', () {
        ...
        final expected = Series([false, false, true, false], name: 's_int_null_isna', index: s.index);
        final result = s.isna();
        expect(result.data, equals(expected.data));
      });
      ...
      test('Series of double with null', () {
        ...
        final expected = Series([false, true, false], name: 's_double_null_isna', index: s.index);
        final result = s.isna();
        expect(result.data, equals(expected.data));
      });
      ...
      test('Series of bool with null', () {
        ...
        final expected = Series([false, false, true], name: 's_bool_null_isna', index: s.index);
        final result = s.isna();
        expect(result.data, equals(expected.data));
      });
    });
    ...
    group('Series.notna()', () {
      test('Basic functionality with nulls', () {
        final s = Series([1, null, 3, null, 5], name: 's_nulls');
        final expected = Series([true, false, true, false, true], name: 's_nulls_notna', index: s.index);
      ...
      test('No missing values', () {
        final s = Series([1, 2, 3], name: 's_no_nulls');
        final expected = Series([true, true, true], name: 's_no_nulls_notna', index: s.index);
        final result = s.notna();
        expect(result.data, equals(expected.data));
        expect(result.name, equals(expected.name));
      });
      ...
      test('All missing values (null)', () {
        final s = Series([null, null, null], name: 's_all_nulls');
        final expected = Series([false, false, false], name: 's_all_nulls_notna', index: s.index);
        final result = s.notna();
        expect(result.data, equals(expected.data));
        expect(result.name, equals(expected.name));
      });
      ...
      test('Custom missing value (-1) via DataFrame context', () {
        ...
        final s = df['colA'];
        final expected = Series([true, false, true], name: 'colA_notna', index: s.index);
        final result = s.notna();
        expect(result.data, equals(expected.data));
        expect(result.name, equals(expected.name));
      });
  ...
  group('DataFrame Missing Data Functions:', () {
    ...
    group('DataFrame.isna()', () {
      ...
      test('Custom missing value (-99) for numeric column', () {
        ...
        expect(result.column('Q').data, equals([false, false, false])); // 'MISSING' is a valid string here
      });
      ...
      test('Custom missing value ("MISSING") for string column', () {
        ...
        expect(result.column('P').data, equals([false, false, false])); // -99 is a valid number here
