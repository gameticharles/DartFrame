...
void main() {
  ...
  group('Vectorized Operations Performance Tests', () {
    ...
    test('Vectorized string operations work correctly', () {
      ...
      final contains = series.vectorizedStringOperation('contains', argument: 'o');
      expect(contains.data, equals([true, false, false, false])); // "WORLD" doesn't contain lowercase "o"
    });
  ...
  group('Performance Comparison Tests', () {
    ...
    test('Large dataset performance validation', () async {
      ...
      print('Large dataset operations time: ${stopwatch.elapsedMilliseconds} ms');
    });
  });
